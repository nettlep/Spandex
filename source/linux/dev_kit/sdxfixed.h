...
inline	FXD   FLT_TO_FXD( float start );                // Faster than a cast/FMUL
...
#if defined(_OS_LINUX) && defined(_CPU_INTEL)
inline	FXD   FLT_TO_FXD( float start )
{
	int	result;
...
inline	FXD   FLT_TO_FXD( float start )
{
	return (FXD) (start * 65536.0f);
}
#endif // defined(_OS_LINUX) && deinfed(_CPU_INTEL)

/*----------------------------------------------------------------------------*/

inline INT   FLT_TO_INT( float start );                // Faster than a cast (no round)
...
#if defined(_OS_LINUX) && defined(_CPU_INTEL)
inline	INT   FLT_TO_INT( float start )
{
	int	result;
...
inline	FXD FixedMul(FXD Val1, FXD Val2);               // With rounding...
...
#if defined(_OS_LINUX) && defined(_CPU_INTEL)
inline	FXD FixedMul(FXD Val1, FXD Val2)
{
	int	result;
...
inline	FXD FixedMul(FXD Val1, FXD Val2)
{
	FLT v1 = (float) Val1 * (1.0f / 65536.0f);
	FLT v2 = (float) Val2 * (1.0f / 65536.0f);
	return FLT_TO_FXD(v1 * v2);
}
#endif // defined(_OS_LINUX) && deinfed(_CPU_INTEL)

/*----------------------------------------------------------------------------*/

inline	FXD FixedDiv(FXD Val1, FXD Val2);               // No rounding...
...
#if defined(_OS_LINUX) && defined(_CPU_INTEL)
inline	FXD FixedDiv(FXD Val1, FXD Val2)
{
	int	result;
