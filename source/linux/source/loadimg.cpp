...
static   INT   StoreLineGif( UCHR *Pixels, INT LineLength, UCHR *Buffer, INT ImgWidth, INT Y );
static   INT   StoreLineG24( UCHR *Pixels, INT LineLength, UCHR *Buffer, INT ImgWidth, INT Y );
...
IMAGE *TImage;
   ...
   TImage->Buffer = (UCHR *) SPDXMalloc( TImage->ResX * TImage->ResY * 3 );
...
INT   StoreLineGif( UCHR *Pixels, INT LineLength, UCHR *Buffer, INT ImgWidth, INT Y )
{
INT   i;
CHR   *cTemp;
...
INT   StoreLineG24( UCHR *Pixels, INT LineLength, UCHR *Buffer, INT ImgWidth, INT Y )
{
INT   i;
