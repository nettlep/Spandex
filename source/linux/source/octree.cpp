...
void  _SPDXOctreeMakeTransTable(IMAGE *PaletteTable, IMAGE *TransTable, UINT number_colors, UINT tree_depth, UBYT *Palette, FLT Opacity)
{
INT   i, j;
UCHR  *TempPtr;
Nodes *nodes;
FLT   red, green, blue;
   ...
   FUNC("_SPDXOctreeMakeTransTable");
   Assert( PaletteTable );
   Assert( TransTable );
   Assert( Palette );
