...
static   void  AddObjectToRenderList(OBJ *Object, OBJ *Cam, VSCR *VScreen);
...
INT   Ticks_hi, Ticks_lo, Ticks;
   ...
   SPDXDrawRenderList( &RList, Cam, SolidRenderers, TransRenderers, VScreen );
...
INT   i;
   ...
   // Add me to the list
   AddObjectToRenderList(Object, Cam, VScreen);
}

/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±*/

void  AddObjectToRenderList(OBJ *Object, OBJ *Cam, VSCR *VScreen)
{
