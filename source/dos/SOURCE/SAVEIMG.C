...
INT   WriteGIF( CHR *FileName, IMAGE *Image )
{
   ...
   SPDXQuantizeImage( Image, 256, 8, Palette );

   GlobBuffer = Image;

   return SPDXGifEncoder(FileName, Image->ResX, Image->ResY, (CHR *) Palette, GetGifPixel);
}
...
INT   i, RetCode;
   ...
   RetCode = SPDXGifEncoder(FileName, Image->ResX, Image->ResY * 3, (CHR *) Palette, GetG24Pixel);
