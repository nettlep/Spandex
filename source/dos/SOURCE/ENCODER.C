...
static INT  maxcode;
static INT  maxmaxcode = (INT)1 << BITS;
...
INT   SPDXGifEncoder( CHR *FName, INT GWidth, INT GHeight, CHR *Palette, ifunptrgp GetPixel )
{
...
INT   i;
   ...
   Handle = SPDXOpen( FName, O_RDWR|O_BINARY|O_TRUNC|O_CREAT, S_IREAD|S_IWRITE );
