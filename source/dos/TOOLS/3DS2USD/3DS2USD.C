...
CHK   Chunk;
   ...
   MatList = realloc(MatList, (MatCount+1) * sizeof(MAT));
...
CHK   Chunk;
   ...
   MeshList = realloc( MeshList, (MeshCount+1) * sizeof(MSH) );
...
void  ReadVertexList(FILE *InFile, FILE *OutFile, INT ChunkLength)
{
   ...
   MeshList[MeshCount].VertexList = malloc( sizeof(P3D) * MeshList[MeshCount].VertexCount );
...
INT   i;
   ...
   MeshList[MeshCount].FaceList = malloc( sizeof(FACE) * MeshList[MeshCount].FaceCount );
...
FLT   *fTemp;
   ...
   MeshList[MeshCount].UVList = malloc( sizeof(P2D) * MeshList[MeshCount].UVCount );
...
CHK   Chunk;
   ...
   LgtList = realloc( LgtList, (LgtCount+1) * sizeof(LGT) );
...
void  ReadCamera(FILE *InFile, FILE *OutFile, INT ChunkLength)
{
   ...
   CamList = realloc( CamList, (CamCount+1) * sizeof(CAM) );
