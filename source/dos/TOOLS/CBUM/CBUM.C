...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
  ...
  ±                                                                          ±
  ±   [CBUM.C      ] - Spandex Bum file compresor                            ±
  ±                                                                          ±
  ±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±*/
...
{
INT   i, Handle, RetCode, CompressedLength, SavePos;
WRD   MapCount;
CHR   *FileName, Bits = 8;
MI    *MInfo;
   ...
   if (argc <= 1)
   {
      printf( "Usage: CBum <filename.BUM>\n" );
      return 1;
   }
   ...
   SPDXGlobals.MapList = SPDXMalloc( sizeof(BMAP)*MapCount );
   ...
   MInfo = SPDXMalloc( sizeof(MI) * MapCount );
   ...
   for( i = 0; i < MapCount; i++)
   {
      ...
      SPDXGlobals.MapList[i].Data = SPDXMalloc( SPDXGlobals.MapList[i].XRes*SPDXGlobals.MapList[i].YRes );
   ...
   Handle = SPDXOpen( FileName, O_RDWR|O_BINARY|O_TRUNC|O_CREAT, 0 );
...
void  PrintCopyright( )
{
   printf( "CBUM v1.70 -- BUM file compression program.\n" );
